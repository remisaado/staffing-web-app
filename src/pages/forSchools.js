...
const ForSchools = () => {
  ...
  const textBodyTwo = "Vi fokuserar ständigt på våra nyckelord: stöttning och kompetens. Stöd för er som skola, stöd för personalgruppen och stöttning för eleverna i klassrummet. Kompetens i form av vikarieförmedling, kvalité på undervisningen och social kompetens. Vi finns där för att hjälpa till när ni behöver oss!";
